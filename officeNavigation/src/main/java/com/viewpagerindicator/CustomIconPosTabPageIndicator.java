 ...
 */
public class CustomIconPosTabPageIndicator extends HorizontalScrollView
    ...
    /**
     * Holds the value used by setCompoundDrawablesWithIntrinsicBounds used to
     * denote no icon.
     */
    ...
    public CustomIconPosTabPageIndicator(Context context) {
        this(context, null);
    }

    public CustomIconPosTabPageIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void addTab(int index, CharSequence text, int iconResId) {
        ...
        if (iconResId != 0) {
            ...
            tabView.setCompoundDrawablesWithIntrinsicBounds(drawables[0],
